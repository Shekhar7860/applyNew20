...
const advert2 = firebase
  .admob()
  .rewarded('ca-app-pub-3550043356338169/5722030580');
const advert = firebase
  .admob()
  .interstitial('ca-app-pub-3550043356338169/2336678711');
...
export default class Welcome extends Component {
  ...
  share = () => {
    Share.share(
      {
        message:
          'Checkout Vestige Products - https://play.google.com/store/apps/details?id=com.vestigeproductslist',
        url:
          'https://play.google.com/store/apps/details?id=com.vestigeproductslist',
        ...
        <View style={styles.content}>
          ...
          <View style={styles.messageBox}>
            <Text style={styles.messageBoxBodyText}>
              Hello, This application can help you to calculate GPA (Global
              Point Average). If you obtain higher GPA, you can get admission in
              top colleges in Bangladesh
            </Text>
            <TouchableHighlight
            ...
            <TouchableHighlight
              style={styles.fullWidthButton}
              onPress={() => this.goToPage('Register')}>
