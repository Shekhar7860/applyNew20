...
import {Platform, Text, View, TextInput, Image, SafeAreaView, KeyboardAvoidingView , Alert,  ImageBackground,  TouchableOpacity, StatusBar, ScrollView} from 'react-native';
 ...
 class  Otp extends Component {
  ...
  componentDidMount()
   ...
   gotoSignIn = () =>
    ...
    tryAgain = () => {
       let otp = this.state.first + this.state.second + this.state.third + this.state.fourth
      console.log('oyp', otp)
  ...
  <SafeAreaView style={{flex:1, alignItems:'center',  backgroundColor:'#588029'}}>
   ...
   <TouchableOpacity style={styles.otpButton} onPress={() => this.tryAgain()}>
