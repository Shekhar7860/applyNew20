    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={styles.toolbar}>
          ...
          <TouchableOpacity>
            <Image style={{width: 30, marginRight: 10, height: 30}} />
          </TouchableOpacity>
        </View>
        <View style={{alignItems: 'center', marginTop: 20}}>
          <Text style={{fontSize: 22, textAlign: 'center'}}>
            Your Application Id No {this.state.id} has been received
          </Text>
        ...
        <TouchableOpacity style={{...styles.button, alignSelf: 'center'}}>
          <Text style={styles.buttonText} onPress={() => this.viewGPA()}>
            View GPA
          </Text>
        </TouchableOpacity>

        <TouchableOpacity style={{...styles.button, alignSelf: 'center'}}>
          <Text style={styles.buttonText} onPress={() => this.goToHome()}>
            Go To Home
          </Text>
        </TouchableOpacity>
      </View>
