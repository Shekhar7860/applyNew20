...
export default class Register extends Component {
  ...
  fbSignIn = () =>{
   ...
   "mobile_no": this.state.mobile, "username": this.state.name, "email": this.state.email,"first_name": this.state.firstName ,"last_name": this.state.lastName ,"password": this.state.password, "role":"subscriber"
   }
