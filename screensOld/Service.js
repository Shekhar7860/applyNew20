...
calculator = (userId, token, stname, parentname, email, phone, score,  sub,sub1,  sub2, sub3, sub4,bio, phy, che, value, picker1, picker2) => 
{
  alert(token)
var cat = "GEN"
if (value =1){
...
console.log('data', data)
 ...
 return fetch(`https://www.mbbsbangladesh.com/wp-json/mbbs-api/check-otp/${userId}/${otp}`, {
  method: "GET"
}).then((response) => 
   response.json())
   .catch((error) => {
...
console.log('data', data)
 ...
 return fetch(`https://www.mbbsbangladesh.com/wp-json/mbbs-api/resend-otp/${userId}`, {
  method: "GET"
}).then((response) => 
   response.json())
   .catch((error) => {
  ...
  viewGPA = (id) => {
        var data = { "id": id}
console.log('data', data)
 return fetch(`https://www.mbbsbangladesh.com/wp-json/mbbs-api/view-gpa/${id}`, {
  method: "GET"
}).then((response) => 
   response.json())
   .catch((error) => {
